...
EVENT_TYPE_GENITIVE: dict[str, str] = {
    "День открытых дверей": "дня открытых дверей",
    "Профориентационный выезд": "профориентационного выезда",
    "Работа с обращениями и звонками": "работы с обращениями и звонками",
    "Обучение участников отряда": "обучения участников отряда",
    "Фестиваль науки": "фестиваля науки",
    "Профориентационная встреча": "профориентационной встречи",
    "Карьерное мероприятие": "карьерного мероприятия",
    "Олимпиада": "олимпиады",
