    ...
    <div className="documents-spravki-page">
      ...
      <section className="documents-spravki-page__panel">
        <div className="documents-spravki-page__controls">
          <label className="documents-spravki-page__field documents-spravki-page__field--event">
        ...
        {selectedEvent ? (
          <div className="documents-spravki-page__event-summary">
      ...
      <section className="documents-spravki-page__table-frame">
        <table className="documents-spravki-page__table">
          ...
          <tbody>
            {!eventId ? (
              <tr>
                <td colSpan="5" className="documents-spravki-page__empty">Выберите мероприятие.</td>
              </tr>
